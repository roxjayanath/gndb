 <div id="menu_wrap">
	...
	<div id="my_profile2" class="my_style">
        	<a href="docholder.php" class="profile_link"><p class="toc">Find Document Holder</p></a>
        
        </div>
        
        <div id="my_profile2" class="my_style">
        	<a href="viwe_document.php" class="profile_link"><p class="toc">View Documents</p></a>
        ...
        <!--<div id="my_profile" class="my_style">
        	<a href="new_admin.php" class="profile_link"><p class="toc">User Control Menu</p></a>
