 <div id="menu_wrap">
	...
	<div id="my_profile" class="my_style">
        ...
        <div id="my_profile" class="my_style">
        	<a href="new_admin.php" class="profile_link"><p class="toc">Add New User</p></a>
        
        </div>
		<?php } ?>
       <?php if($user->rights[RIGHT_USER_CONTROL]){ ?>
        <div id="my_profile" class="my_style">
        	<a href="editadmin.php" class="profile_link"><p class="toc">Edit Users</p></a>
       ...
       <?php if($user->rights[RIGHT_USER_CONTROL]){ ?>
        <div id="my_profile" class="my_style">
        	<a href="user_control.php" class="profile_link"><p class="toc">User Control Menu</p></a>
